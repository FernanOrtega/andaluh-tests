...
data_folder = "europarl_unified" # "europarl_unified"
...
# Vectorize the data (char-based approach)
...
# Save model
model.save(f's2s-{num_samples}-{epochs}.h5')
...
for seq_index in range(max(5, int(num_samples/100))):
    ...
    print('Expected sentence:', target_texts[seq_index].replace('[\t\n]', ''))
